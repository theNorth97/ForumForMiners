...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title text-center mb-4 ">Войти в личный кабинет</h4>
                    <form action="/login" class="form-signin" method="POST">
                        ...
                        <button class="btn btn-primary btn-sm mx-auto" type="submit">Войти в личный кабинет</button>
                        <div id="login-link" class="text-center my-3">
                            <a href="http://localhost/registration">Регистрация</a>
                        </div>
                    </form>
                </div>
            </div>
